...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:template match="/">
    ...
    <html>
      <head>
        <title>Vehículos Eléctricos - Datos Relevantes</title>
        <style>
          body {
      ...
      <body>
        <h1>Vehículos Eléctricos - Datos Relevantes</h1>
        ...
        <table>
          ...
          <!-- Solo mostrar los primeros 100 vehículos -->
  ...
  <!-- Plantilla para cada fila (solo datos relevantes) -->
